            ...
            <div className="bg-gradient-to-r from-cyan-400 to-sky-400 min-h-screen flex items-center justify-center">
                ...
                <div className="w-1/3 h-screen min-h-690px bg-white flex items-center justify-center">
                    <div className="w-2/3 max-w-container">
                        ...
                        <form className="grid space-y-6" id="myForm" onSubmit={handleSubmit}>
                            <div>
                                <label className="text-slate-800 pb-2 block">User Name</label>
                                <input type="text" value={userName} onChange={handleusername} id="username" className="h-10 rounded-md px-3 py-2 border text-xs focus:outline-none w-full" placeholder="User Name" />
                                {/* {emailError ? <span style={{ color: "red" }}>Invalid Email</span> : ""} */}
                            </div>
                            <div>
                                <label className="text-slate-800 pb-2 block">Password</label>
                                <input type="password" value={password} onChange={handlepassword} id="password" className="h-10 rounded-md px-3 py-2 border text-xs focus:outline-none w-full" placeholder="12345678" />
